    ...
    try {
      ...
      for (const [id, value] of Object.entries(raw)) {
        ...
        profiles.set(id, {
          ...
          // A profile written before a ladder existed owns none of it, which
          // is exactly what a zero mask means - no migration needed. The free
          // starter tiers are OR-ed back in on restore.
          ownedUpgrades: numeric(value.ownedUpgrades),
          ...
          ownedCharms: numeric(value.ownedCharms),
          equippedCharms: numeric(value.equippedCharms),
