 ...
 * landing, so the player fell straight through the solid ground underneath it
 * and never recovered.
 *
...
export interface CourseTriggers {
  ...
  /** True if the player intersects a hazard. */
  hazard: boolean;
...
export class WorldCollision {
  ...
  /**
   * True when the player intersects a hazard at `time`.
   *
